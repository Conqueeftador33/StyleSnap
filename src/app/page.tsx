...
const HomePage = React.memo(function HomePage() {
  return (
    <div className="space-y-12">
      ...
      <section className="text-center pt-8 md:pt-12 pb-4 rounded-lg shadow-xl bg-gradient-to-br from-primary/10 via-background to-background overflow-hidden md:-mt-[150px]">
        <div className="container mx-auto px-4">
          <div className="md:grid md:grid-cols-2 md:gap-12 md:items-center">
            ...
            <div className="text-center md:text-left mt-8 md:mt-12 md:translate-y-[100px]">
